...
set_property PACKAGE_PIN T22 [get_ports {digit_0[0]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {digit_0[1]}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {digit_0[2]}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {digit_0[3]}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {digit_0[4]}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {digit_0[5]}];  # "LD5"
set_property PACKAGE_PIN U19 [get_ports {digit_0[6]}];  # "LD6"
set_property PACKAGE_PIN U14 [get_ports {digit_0[7]}];  # "LD7"
